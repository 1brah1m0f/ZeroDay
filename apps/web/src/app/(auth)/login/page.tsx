...
export default function LoginPage() {
  ...
  return (
    <div className="animate-fade-up">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-stone-800">Xoş gəldin!</h1>
        <p className="mt-1 text-sm text-stone-500">Hesabına daxil ol və icma ilə birləş.</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm text-primary-600 hover:underline cursor-pointer">Şifrəni unutdum</span>
        </div>
